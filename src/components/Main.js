...
const Main = () => {
  return (
    ...
    <div className="max-w-[1000px] lg:mx-auto ml-7  px-8 flex flex-col justify-center h-full">
       ...
       <h1 className="text-gray-300 text-4xl sm:text-7xl font-bold"> Viktorija Kuneviciute</h1>
       ...
       <div>
           <button className="text-white group border-2 flex items-center px-5 py-2 my-2 hover:bg-[#00c4cc] hover:border-[#00c4cc]">See my work 
