    ...
    <div name="main" className="w-full h-screen bg-[#001219]">
      ...
      <div className="max-w-[1100px] w-full flex lg:flex-row flex-col items-center justify-center h-full md:mx-auto">
        ...
        <div className="lg:pl-10 md:pl-10 sm:px-0 px-10">
          ...
          <div>
            <button className="text-gray-400 md:text-lg text-m group border border-gray-400 flex items-center sm:px-5 sm:py-2 px-2 py-1 my-4 hover:bg-[#00c4cc] hover:border-[#00c4cc] hover:text-white">
        ...
        <div className="sm:pt-0 pt-4">
          ...
          <img src={grafik2} alt="" className="md:w-[340px] w-[180px] sm:w-[260px] invisible sm:visible hidden sm:block" />
        </div>
      </div>
    </div>
