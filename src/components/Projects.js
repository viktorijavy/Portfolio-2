            ...
            <div className="max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full border-t">
                ...
                <div className="w-full grid grid-cols-1 md:grid-cols-2 py-12 text-center gap-x-4 sm:gap-y-[150px] gap-y-[50px]">
                    ...
                    <div className="">
                        ...
                        <div className="mt-6">
                            <a
                                className="border px-4 py-2 hover:bg-[#00c4cc] hover:border-[#00c4cc]"
                    ...
                    <div className="">
                        ...
                        <div className="mt-6">
                            <a
                                className="border py-2 px-4 mr-4 hover:bg-[#00c4cc] hover:border-[#00c4cc]"
                            ...
                            <a
                                className="border py-2 px-4 hover:bg-[#00c4cc] hover:border-[#00c4cc]"
